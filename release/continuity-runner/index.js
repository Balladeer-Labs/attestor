...
function closedResult(pkg, control, started, sourceSha, outcome, exitCode, custody) {
    const completed = new Date();
    const base = {
        schemaVersion: RUNNER_SCHEMA,
        runnerVersion: RUNNER_VERSION,
